...
<body id="body">
    <div id="main">
        <form id="form" class="pt50 ls animated">
            <h3 class="w300 bc mb15 c f20 lh200 pl10 pb5 fc3">修改密码<a href="../square/square.php" class="fr fcm mr10" title="首页">童年网</a></h3>
            <label class="w300 bc db mb15 radius4 pl10 ts4">
                <input data-role="name" name="pass" class="m-name w200 h40 bct fc3 animated" type="text" placeholder="请输入您的用户名" />
            </label>
            <label class="w300 bc db mb15 radius4 pl10 ts4">
    ...
    ?>
    <!-- this -->
    <script src="../view/js/passmodify.js"></script>
</body>
